      ...
      switch (position) {
        ...
        case "right":
          ...
          if (
            ...
            style.top = "0";
            style.transform =
              style.left === "100%" ? "translateX(8px)" : "translateX(-8px)";
        ...
        case "left":
          ...
          if (
            ...
            style.top = "0";
            style.transform =
              style.right === "100%" ? "translateX(-8px)" : "translateX(8px)";
            arrowStyle.top = triggerRect.top + triggerRect.height / 2 + "px";
          } else if (
            triggerRect.top + triggerRect.height / 2 + popoverRect.height / 2 >
            viewportHeight
...
const determineTaskSectionVisibility = (
  sectionName,
  task,
  isEditing,
  activeSections
...
function TaskCard({
  ...
  const [editedUserImpact, setEditedUserImpact] = useState(
    task.userImpact || ""
  );
  ...
  const [commandsExpanded, setCommandsExpanded] = useState(() => {
    if (typeof window !== "undefined") {
      const savedState = localStorage.getItem(
        `${UI_STORAGE_KEYS.COMMANDS_EXPANDED}_${task.id}`
      );
      if (savedState !== null) {
        return savedState === "true";
      }
  ...
  const handleInlineSubmit =
    (field: string) => (e: React.FormEvent | React.FocusEvent) => {
      e.preventDefault();
      e.stopPropagation(); // Prevent card expansion
  ...
  const renderAgentActions = () => {
    ...
    if (
      task.status !== "done" &&
      !["archived", "reviewed"].includes(task.status as string)
    ) {
      agentActions.push(
        <AgentLauncher
          key="deploy-agent"
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              ...
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.TO_BACKLOG.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
      ...
      actions.push(
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {STATUS_ACTION_HELP.ARCHIVE.title}
              </h4>
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.ARCHIVE.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {
                  getActionHelp(TASK_STATUSES.TODO, "Starting work on this?")
                    .title
                }
              </h4>
              <p className="text-sm text-gray-600">
      ...
      actions.push(
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {STATUS_ACTION_HELP.ON_HOLD.title}
              </h4>
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.ON_HOLD.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {
                  getActionHelp(TASK_STATUSES.IN_PROGRESS, "Finished the work?")
                    .title
                }
              </h4>
              <p className="text-sm text-gray-600">
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              ...
              <p className="text-sm text-gray-600">
                If you need to reprioritize this task, move it back to Todo
                status.
              </p>
            </div>
          }
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {
                  getActionHelp(TASK_STATUSES.ON_HOLD, "Ready to resume work?")
                    .title
                }
              </h4>
              <p className="text-sm text-gray-600">
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              ...
              <p className="text-sm text-gray-600">
                Move this task back to Todo status if it's no longer blocked but
                you're not ready to work on it yet.
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
      ...
      actions.push(
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {STATUS_ACTION_HELP.REOPEN.title}
              </h4>
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.REOPEN.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              ...
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.MOVE_TO_DONE.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              ...
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.UNARCHIVE.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
        ...
        <Popover
          ...
          content={
            <div className="w-64">
              ...
              <p className="text-sm text-gray-600">
                This will move the task back to the reviewed state, making it
                visible in the active task lists again.
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
      ...
      actions.push(
        <Popover
          ...
          content={
            <div className="w-64">
              <h4 className="font-medium text-gray-900 mb-1">
                {STATUS_ACTION_HELP.DELETE.title}
              </h4>
              <p className="text-sm text-gray-600">
                {STATUS_ACTION_HELP.DELETE.description}
              </p>
            </div>
          }
          position={POPOVER_POSITIONS.TOP}
    ...
    >
            ...
            <div className="flex items-start justify-between mb-1">
              {isEditingInitiative ? (
                ...
                <h2
                  ...
                  onDoubleClick={(e) =>
                    onUpdateTask && handleInlineEdit("initiative")(e)
                  }
                >
                  {task.initiative}
                  {onUpdateTask && (
            ...
            <div className="flex items-start w-full">
              {isEditingTitle ? (
                ...
                <h3
                  ...
                  onDoubleClick={(e) =>
                    onUpdateTask && handleInlineEdit("title")(e)
                  }
                >
                  {task.title}
                  {onUpdateTask && (
                ...
                <div className="text-base text-gray-600 line-clamp-2">
                  {isEditingUserImpact ? (
                    ...
                    <div
                      ...
                      onDoubleClick={(e) =>
                        onUpdateTask && handleInlineEdit("userImpact")(e)
                      }
                    >
                      {task.userImpact ||
                        task.description ||
                  ...
                  <div className="text-base text-gray-600">
                    {isEditingDescription ? (
                      ...
                      <div
                        className="group cursor-pointer whitespace-pre-wrap break-words"
                        onDoubleClick={(e) =>
                          onUpdateTask && handleInlineEdit("description")(e)
                        }
                      >
                        {task.description}
                        {onUpdateTask && (
          ...
          <div className="relative">
            ...
            <div
              className={`transition-all duration-300 ease-in-out overflow-hidden ${
                task.status !== TASK_STATUSES.FOR_REVIEW || commandsExpanded
      ...
      {expanded && (
        <div className="px-4 pb-4 pt-2 border-t border-gray-100">
          ...
          {/* Markdown Content */}
          {((task.markdown && task.markdown.length > 0) ||
            isEditingMarkdown ||
            expanded) && (
            <div
              id={`markdown-${task.id}`}
              ...
              >
                {isEditingMarkdown ? (
                  ...
                  >
                    ...
                    <div
                      className="relative z-0 pointer-events-none min-h-[48px] block"
                      style={{ display: "block" }}
                    >
                      {editedMarkdown ? (
                        <ReactMarkdown
                        ...
                        <p
                          ...
                          style={{ display: "block" }}
                        >
                          Start typing to add markdown content...
                        </p>
                      )}
                    </div>
                  ...
                  <>
                    {task.markdown ? (
                      ...
                      <p className="text-gray-400 italic">
                        No details added yet. Click to add markdown details.
                      </p>
                    )}
                  </>
                )}
          ...
          {onUpdateTask && expanded && (
            <div className="mt-6 mb-2 flex flex-wrap gap-x-2 gap-y-2 border-t border-gray-100 pt-3 pb-1">
              {determineTaskSectionVisibility(
                "verificationSteps",
                task,
                onUpdateTask,
                editingSections
              ...
              {determineTaskSectionVisibility(
                ...
                <button
                  onClick={(e) => {
                    ...
                    setTimeout(() => {
                      const technicalSection = document.getElementById(
              ...
              {determineTaskSectionVisibility(
                ...
                <button
                  onClick={(e) => {
                    ...
                    setTimeout(() => {
                      const nextStepsSection = document.getElementById(
                        `next-steps-${task.id}`
                      );
                      if (nextStepsSection) {
            ...
            >
              ...
              {onUpdateTask ? (
                <ApprovalItemList2
                  ...
                  items={
                    task.verificationSteps?.map((step) => ({
            ...
            >
              ...
              task.requirementItems ? (
                <ApprovalItemList
                  ...
                  onApprove={(itemId) => {
                    console.log(
                      `[TaskCard] Requirements - onApprove handler triggered for task ${task.id}, item ${itemId}`
                    );
                    if (onApproveRequirementItem) {
                      console.log(
                        `[TaskCard] Requirements - Calling onApproveRequirementItem handler`
                      );
                      onApproveRequirementItem(task.id, itemId)
                        .then(() =>
                          console.log(
                            `[TaskCard] Requirements - onApproveRequirementItem completed successfully for item ${itemId}`
                          )
                        )
                        .catch((error) =>
                          console.error(
                            `[TaskCard] Requirements - Error in onApproveRequirementItem:`,
                            error
                          )
                        );
                    } else {
                      console.log(
                        `[TaskCard] Requirements - onApproveRequirementItem handler not available`
                      );
                    }
                  }}
                  onVeto={(itemId) => {
                    console.log(
                      `[TaskCard] Requirements - onVeto handler triggered for task ${task.id}, item ${itemId}`
                    );
                    if (onVetoRequirementItem) {
                      console.log(
                        `[TaskCard] Requirements - Calling onVetoRequirementItem handler`
                      );
                      onVetoRequirementItem(task.id, itemId)
                        .then(() =>
                          console.log(
                            `[TaskCard] Requirements - onVetoRequirementItem completed successfully for item ${itemId}`
                          )
                        )
                        .catch((error) =>
                          console.error(
                            `[TaskCard] Requirements - Error in onVetoRequirementItem:`,
                            error
                          )
                        );
                    } else {
                      console.log(
                        `[TaskCard] Requirements - onVetoRequirementItem handler not available`
                      );
                    }
                  }}
                />
                ...
                <ApprovalItemList2
                  ...
                  onUpdate={(newItems) => {
                    if (onUpdateTask) {
                      onUpdateTask(task.id, task.project, {
                        requirements: formatBulletedList(
                          newItems.map((item) => item.content)
                        ),
                      });
                    }
                  }}
            ...
            >
              ...
              task.technicalPlanItems ? (
                <ApprovalItemList
                  ...
                  onApprove={(itemId) => {
                    console.log(
                      `[TaskCard] TechnicalPlan - onApprove handler triggered for task ${task.id}, item ${itemId}`
                    );
                    if (onApproveTechnicalPlanItem) {
                      console.log(
                        `[TaskCard] TechnicalPlan - Calling onApproveTechnicalPlanItem handler`
                      );
                      onApproveTechnicalPlanItem(task.id, itemId)
                        .then(() =>
                          console.log(
                            `[TaskCard] TechnicalPlan - onApproveTechnicalPlanItem completed successfully for item ${itemId}`
                          )
                        )
                        .catch((error) =>
                          console.error(
                            `[TaskCard] TechnicalPlan - Error in onApproveTechnicalPlanItem:`,
                            error
                          )
                        );
                    } else {
                      console.log(
                        `[TaskCard] TechnicalPlan - onApproveTechnicalPlanItem handler not available`
                      );
                    }
                  }}
                  onVeto={(itemId) => {
                    console.log(
                      `[TaskCard] TechnicalPlan - onVeto handler triggered for task ${task.id}, item ${itemId}`
                    );
                    if (onVetoTechnicalPlanItem) {
                      console.log(
                        `[TaskCard] TechnicalPlan - Calling onVetoTechnicalPlanItem handler`
                      );
                      onVetoTechnicalPlanItem(task.id, itemId)
                        .then(() =>
                          console.log(
                            `[TaskCard] TechnicalPlan - onVetoTechnicalPlanItem completed successfully for item ${itemId}`
                          )
                        )
                        .catch((error) =>
                          console.error(
                            `[TaskCard] TechnicalPlan - Error in onVetoTechnicalPlanItem:`,
                            error
                          )
                        );
                    } else {
                      console.log(
                        `[TaskCard] TechnicalPlan - onVetoTechnicalPlanItem handler not available`
                      );
                    }
                  }}
                />
                ...
                <ApprovalItemList2
                  ...
                  onUpdate={(newItems) => {
                    if (onUpdateTask) {
                      onUpdateTask(task.id, task.project, {
                        technicalPlan: formatNumberedList(
                          newItems.map((item) => item.content)
                        ),
                      });
                    }
            ...
            >
              ...
              task.nextStepItems ? (
                <ApprovalItemList
                  ...
                  onApprove={(itemId) => {
                    console.log(
                      `[TaskCard] NextSteps - onApprove handler triggered for task ${task.id}, item ${itemId}`
                    );
                    if (onApproveNextStepItem) {
                      console.log(
                        `[TaskCard] NextSteps - Calling onApproveNextStepItem handler`
                      );
                      onApproveNextStepItem(task.id, itemId)
                        .then(() =>
                          console.log(
                            `[TaskCard] NextSteps - onApproveNextStepItem completed successfully for item ${itemId}`
                          )
                        )
                        .catch((error) =>
                          console.error(
                            `[TaskCard] NextSteps - Error in onApproveNextStepItem:`,
                            error
                          )
                        );
                    } else {
                      console.log(
                        `[TaskCard] NextSteps - onApproveNextStepItem handler not available`
                      );
                    }
                  }}
                  onVeto={(itemId) => {
                    console.log(
                      `[TaskCard] NextSteps - onVeto handler triggered for task ${task.id}, item ${itemId}`
                    );
                    if (onVetoNextStepItem) {
                      console.log(
                        `[TaskCard] NextSteps - Calling onVetoNextStepItem handler`
                      );
                      onVetoNextStepItem(task.id, itemId)
                        .then(() =>
                          console.log(
                            `[TaskCard] NextSteps - onVetoNextStepItem completed successfully for item ${itemId}`
                          )
                        )
                        .catch((error) =>
                          console.error(
                            `[TaskCard] NextSteps - Error in onVetoNextStepItem:`,
                            error
                          )
                        );
                    } else {
                      console.log(
                        `[TaskCard] NextSteps - onVetoNextStepItem handler not available`
                      );
                    }
                  }}
                />
                ...
                <ApprovalItemList2
                  ...
                  onUpdate={(newItems) => {
                    if (onUpdateTask) {
                      // Convert ItemWithStatus objects back to strings and
                      // update directly
                      const stringItems = newItems.map((item) => item.content);

                      onUpdateTask(task.id, task.project, {
                        nextSteps: stringItems,
                      });
                    }
                  }}
                />
          ...
          <div className="mt-4 text-xs text-gray-500">
            ...
            <div className="flex justify-between">
              ...
              <span
                ...
                title={
                  onUpdateDate ? "Click to edit creation date" : "Creation date"
                }
              >
              ...
              <div className="text-right">
                ...
                {task.completedAt && (
                  <p>Completed {formatTimeAgo(task.completedAt)}</p>
                )}
                {task.reviewedAt && (
                  <p>Reviewed {formatTimeAgo(task.reviewedAt)}</p>
                )}
              </div>
            </div>
          </div>
...
export default React.memo(TaskCard, (prevProps, nextProps) => {
  ...
  return (
    ...
    JSON.stringify(prevProps.task.nextStepItems) ===
      JSON.stringify(nextProps.task.nextStepItems) &&
    // Compare handlers
    ...
    prevProps.onApproveTechnicalPlanItem ===
      nextProps.onApproveTechnicalPlanItem &&
    prevProps.onVetoTechnicalPlanItem === nextProps.onVetoTechnicalPlanItem &&
    prevProps.onUpdateTechnicalPlanItems ===
      nextProps.onUpdateTechnicalPlanItems &&
